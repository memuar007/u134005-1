...
<?if(!defined("B_PROLOG_INCLUDED")||B_PROLOG_INCLUDED!==true)die();?> <?use Bitrix\Main\Localization\Loc; use Bitrix\Main\Page\Asset; Loc::loadMessages(__FILE__);?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?=LANGUAGE_ID?>">
<head profile="http://gmpg.org/xfn/11">

    <title <?$APPLICATION->ShowTitle();?>>Novux</title>
    <?$APPLICATION->ShowHead();?>
    <?if(!CSite::InDir('/')):?><a href="/"><?endif;?> <img src="<?=SITE_TEMPLATE_PATH;?>/images/logo.png" alt="Novux" />
...
<?$APPLICATION->ShowHead();?>
<?if(!CSite::InDir('/')):?><a href="/"><?endif;?> <img src=<?=SITE_TEMPLATE_PATH;?>"/images/logo.png" alt="Novux" /> <?if(!CSite::InDir('/')):?></a><?endif;?>
...
=======
    ...
    <!-- Load Alternate Stylesheets, can be disabled if not used -->
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-orange.css");?>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-dirtyblue.css");?>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-redish.cs");?>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-green.css");?>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-pink.css");?>
>>>>>>> task_1_create_site_template
...
<<<<<<< HEAD
    ...
    <!--[endif]-->
=======
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/style-enhance.css");?>
    <!-- End Load -->

    <!-- Load IE Stylesheet -->
    <!--[if IE]>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/ie.css");?>
    <![endif]-->
    <!-- End Load -->

    <!-- Load IE6 Stylesheet -->
    <!--[if IE 6]>
    <?Asset::getInstance()-> addJs(SITE_TEMPLATE_PATH."/_include/css/ie6.css");?>
        ...
        <div class="containit">
            ...
            <div class="menu">
                ...
                <div id="navigation">
                    ...
                    <ul class="sf-menu">
                        <li class="current"><a href="<?=SITE_TEMPLATE_PATH;?>/index-roundabout.html" class="applyfont">Home</a>
                            <ul>
